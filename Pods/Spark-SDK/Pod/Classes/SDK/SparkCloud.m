    ...
    [self.manager POST:@"oauth/token" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! loginWithUser %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
    ...
    [self.manager POST:@"/v1/users" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! signupWithUser %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
    ...
    [self.manager POST:url parameters:[params copy] success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! signupWithCustomer %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
    ...
    [self.manager POST:@"/v1/devices" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! claimDevice %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
    ...
    [self.manager GET:urlPath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! getDevice %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
    ...
    [self.manager GET:@"/v1/devices" parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! getDevices %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
}
    ...
    [self.manager POST:urlPath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! generateClaimCode %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
    ...
    [self.manager POST:urlPath parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! generateClaimCodeForOrganization %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
    ...
    [self.manager POST:urlPath parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! requestPasswordReset %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
    ...
    [self.manager POST:urlPath parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
             NSLog(@"! requestPasswordResetForUser %@ Failed (status code %ld): No Error",operation.request.URL,operation.response.statusCode);
         }
     }];
